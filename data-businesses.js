...
var BUSINESS_DEFS = [
  {
    ...
    levels:[
      ...
      { level:7, name:'智能仓储物流', income:1.90, cost:12000, reqCond:{ techLv:3 } },
      { level:8, name:'全渠道零售', income:2.30, cost:25000, reqCond:{ techLv:3, npcFavor:{ zhaolei:40 } } },
      { level:9, name:'新零售生态', income:2.70, cost:50000, reqCond:{ techLv:4 } },
      { level:10, name:'零售帝国', income:3.20, cost:100000, reqCond:{ techLv:5, rep:70 } },
    ]
  },
  {
  ...
  },
  {
    ...
    levels:[
      ...
      { level:7, name:'全球配置', income:13.0, cost:220000, reqCond:{ techLv:3, npcFavor:{ chenzong:50 } } },
      { level:8, name:'跨境金融', income:15.5, cost:450000, reqCond:{ techLv:4 } },
      { level:9, name:'衍生品帝国', income:18.0, cost:900000, reqCond:{ techLv:4, rep:75 } },
      { level:10, name:'金融王朝', income:21.0, cost:1800000, reqCond:{ techLv:5, rep:85 } },
    ]
  },
  {
    ...
    levels:[
      ...
      { level:7, name:'短视频生态', income:13.00, cost:500000, reqCond:{ techLv:3 } },
      { level:8, name:'内容AI工厂', income:14.50, cost:1000000, reqCond:{ techLv:4 } },
      { level:9, name:'文化输出平台', income:16.00, cost:2000000, reqCond:{ techLv:4, rep:70 } },
      { level:10, name:'传媒王朝', income:18.00, cost:4000000, reqCond:{ techLv:5, rep:80 } },
    ]
  },
  {
    ...
    levels:[
      ...
      { level:7, name:'预制菜品牌', income:3.2, cost:30000, reqCond:{ techLv:3 } },
      { level:8, name:'餐饮数字化', income:4.0, cost:60000, reqCond:{ techLv:3, npcFavor:{ zhaolei:40 } } },
      { level:9, name:'美食生态链', income:5.0, cost:120000, reqCond:{ techLv:4 } },
      { level:10, name:'食神帝国', income:6.0, cost:250000, reqCond:{ techLv:5, rep:65 } },
    ]
  },
  {
    ...
    levels:[
      ...
      { level:7, name:'碳交易平台', income:7.0, cost:75000, reqCond:{ techLv:3, rep:50 } },
      { level:8, name:'虚拟电厂', income:8.5, cost:150000, reqCond:{ techLv:4 } },
      { level:9, name:'绿色电网', income:10.0, cost:300000, reqCond:{ techLv:4, npcFavor:{ lichu:40 } } },
      { level:10, name:'能源新纪元', income:11.5, cost:600000, reqCond:{ techLv:5, rep:75 } },
    ]
  },
]
